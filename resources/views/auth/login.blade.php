...
<!-- Mirrored from massive.markup.themebucket.net/login-register-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:52:33 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--favicon icon-->
    <link rel="icon" type="image/png" src="{{asset('assets/img/favicon.png')}}">

    <title>Login Register 3</title>

    <!--common style-->
    <link href='http://fonts.googleapis.com/css?family=Abel|Source+Sans+Pro:400,300,300italic,400italic,600,600italic,700,700italic,900,900italic,200italic,200' rel='stylesheet' type='text/css'>

    <!-- inject:css -->
    <link rel="stylesheet" src="{{asset('assets/vendor/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/animate/animate.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/elasic-slider/elastic.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/iconmoon/linea-icon.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/magnific-popup/magnific-popup.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/owl-carousel/owl.carousel.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/owl-carousel/owl.theme.css')}}">
    <link rel="stylesheet" src="{{asset('assets/vendor/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" src="{{asset('assets/css/shortcodes.css')}}">
    <link rel="stylesheet" src="{{asset('assets/css/style.css')}}">
    <link rel="stylesheet" src="{{asset('assets/css/default-theme.css')}}">
    <!-- endinject -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="login register login-box gray-bg">

                                <div class="text-left">
                                    <h4>LOGIN</h4>
                                </div>

                                <div class="border-less-input btn-rounded">
                                    <form class=" " action="#" method="post">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-small btn-dark-solid full-width btn-rounded" value="login">Login</button>
                                        </div>

                                        <div class="form-group text-center  m-top-20 inline-block">
                                            <input type="checkbox" value="remember-me" id="checkbox1">
                                            <label for="checkbox1">Remember me</label>
                                        </div>

                                        <div class="form-group text-center">
                                            <a class="" data-toggle="modal" href="#forgotPass"> Forgot Password?</a>
                                        </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde, vel odio non dicta provident sint ex autem mollitia dolorem illum repellat ipsum aliquid illo.</p>

                            <form class=" login magazine-grid" action="#" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button class="btn btn-small btn-dark-solid full-width btn-rounded" id="login-form-submit" name="login-form-submit" value="login">Register</button>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <p>Massive is fully responsible, performance oriented and SEO optimized, retina ready WordPress theme.
                            </p>
...
<!-- Mirrored from massive.markup.themebucket.net/login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:52:32 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
    <meta name="description" content="">
    ...
    <div class="login login-bg login-parallax">
        ...
        <div class="container">
            ...
            <div class="login-box btn-rounded">
                  ...
                  @else
                      <p class="login-box-msg">Đăng Nhập Để Đi Tới Quản Trị</p>
                  @endif
                ...
                <form  action="#" method="post" novalidate>
                  @csrf
                    ...
                    <div class="form-group">
                        <input type="checkbox" value="remember-token" id="">
            ...
            <div class="copyright-row text-center">
                Copyrights © All Rights Reserved by <a href="#" class="theme-color">Massive</a>
            </div>
        </div>
...
<!-- Mirrored from massive.markup.themebucket.net/login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:52:33 GMT -->
</html>
